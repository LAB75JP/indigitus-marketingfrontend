...
(function() {
	...
	var _connection = function(data, callback, scope) {

		var settings = _.assign({}, data);

		callback = callback instanceof Function ? callback : function() {};
		scope    = scope !== undefined          ? scope    : this;


		var socket = new _ssh2();
...
(function() {
  ...
  Instance.prototype._getConnection = function(cb) {
    ...
    c.connect({
      ...
      port: 22,
      username: 'ubuntu',
      privateKey: require('fs').readFileSync(__dirname + '/../../keys/indigitus_ssh_test.pem')
    });
